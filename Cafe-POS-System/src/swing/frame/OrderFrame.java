...
public class OrderFrame extends DefaultFrame {
	...
	static Map<String, Integer> MenuHash = new HashMap<>();
	...
	public OrderFrame() {
		...
		for (int i = 0; i < 11; i++) {
			String[] typeName = { "<HTML>리저브<br>에스프레소</HTML>", "<HTML>리저브<br>드립</HTML>", "콜드 브루", "블론드", "에스프레소",
					"디카페인", "프라푸치노", "블렌디드", "피지오", "티바나", "기타" };
