...
public class EmployeeInfoDelButton implements ActionListener {
	...
	private String sql = "DELETE FROM employees_table WHERE employee_name = ? AND employee_pw = ? AND employee_grade = ?";
	...
	public EmployeeInfoDelButton(ArrayList<TextField> fields, JComboBox<String> grade_box) {
		this.fields = fields;
